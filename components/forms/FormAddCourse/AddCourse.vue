    ...
    <div class="bg-[#F0F0F3] rounded-2xl p-6 w-full max-w-sm shadow-xl">
      ...
      <div class="space-y-4">
        ...
        <input 
          ...
          :placeholder="errors.name ? errors.name : 'Nombre Del Curso'"
        ...
        <div class="flex gap-3 pt-2">
          <button 
            @click="handleCancel"
            class="flex-1 px-4 py-2 rounded-xl bg-white text-gray-700 shadow-[4px_4px_8px_rgba(70,70,70,0.16),-4px_-4px_8px_rgba(255,255,255,0.19)] transition-all duration-500 ease-out transform hover:scale-105 hover:shadow-lg text-sm"
          >
            Cancelar
          </button>
          <button 
            @click="handleSubmit"
            class="flex-1 px-4 py-2 rounded-xl bg-[#003B73] text-white shadow-md transition-all duration-500 ease-out transform hover:scale-105 hover:shadow-lg hover:bg-[#002c56] text-sm"
          >
            Guardar
          </button>
        </div>
