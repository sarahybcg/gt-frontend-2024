<template>
  ...
  <form>
    ...
    <div class="form-group">
      ...
      <input type="number" id="amount" name="amount" placeholder="Monto del presupuesto" />
    </div>
    ...
    <div class="form-group">
      ...
      <textarea id="description" name="description" placeholder="Descripción del presupuesto" rows="4"></textarea>
    </div>
